...
// EXECUTE_OPT
pub(crate) const ADD_NON_SCALAR_CONTIGUOUS_EXECUTE_OPT_SHADERS_PATH: &'static str = include_str!(
    "./operation/element_wise/add/execute_opt/non_scalar/add_contiguous_execute_opt.wgsl"
);
